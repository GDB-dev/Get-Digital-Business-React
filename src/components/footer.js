    ...
    <footer className={`footer-footer ${props.rootClassName} `}>
        ...
        <div className="footer-links-container">
          ...
          <div className="footer-container2">
            <div className="footer-contact">
              ...
              <a href="tel:+447555604997" className="footer-link3">
                {props.text12}
              </a>
            </div>
      ...
      <span className="footer-text06">
        ...
        <span className="">
          ...
          Registered in England and Wales.Agile Delivery Consulting Ltd.Company
          Registration No 14276451.
        </span>
        <br className=""></br>
      </span>
    </footer>
...
Footer.defaultProps = {
  ...
  text10: 'Contact Us',
  text2: 'Pricing',
  text11: 'hello@getdigitalbusiuness.co.uk',
  text4: 'Releases',
  text9: 'Blog',
  text13: 'Follow Us',
  text7: 'Careers',
  ...
  text3: 'Tutorials',
  imagealt: 'logo',
  imagesrc: '/logo-color-cropped-200h.webp',
  text: 'Product',
}
